...
<template>
	<div class="container">
		<div class="cards">
				...
				>
					<div class="abilities">
						<p v-for="(ability, index) in abilities[characters.indexOf(character)]" :key="index">
							{{ ability.ability.name }}<span v-if="index < abilities[characters.indexOf(character)].length - 1">,&nbsp;</span>
						</p>
					</div>
				</Card>
		</div>
